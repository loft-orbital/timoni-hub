...
A [timoni.sh](http://timoni.sh) module for deploying {{name}} to Kubernetes clusters.
...
```shell
timoni -n default apply {{name}} oci://<container-registry-url>
```
